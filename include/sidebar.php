...
<nav class="navbar navbar-inverse sidebar navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-nav-custom">
       ...
       <li><a href="#" onclick="return confirmLogout();">Logout<span style="font-size:16px; color:#5bcad9;" class="pull-right hidden-xs showopacity glyphicon glyphicon-log-out"></span></a></li>
      
        <li <?php if($page_name == "about-us" ){echo "class=\"active\"";} ?>><a id="about-us-link" href="about-us.php">About us<span style="font-size:16px; color:#5bcad9;" class="pull-right hidden-xs showopacity glyphicon glyphicon-exclamation-sign"></span></a></li>
...
<script>
  function confirmLogout() {
    ...
    if (logout) {
      window.location.href = "?logout=logout"; // Redirect to logout URL
    }
    return logout; // If true, it will log out; otherwise, it will cancel
  }
</script>
